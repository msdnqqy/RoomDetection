...
class NetWork:
    ...
    def buildnet(self):
        ...
        self.conv1=tf.layers.conv2d(self.tf_x,64,3,2,activation=tf.nn.relu6,padding='valid')#112
        self.pool1=tf.layers.max_pooling2d(self.conv1,2,2)#64

        self.conv2 = tf.layers.conv2d(self.pool1, 128, 3, 2, activation=tf.nn.relu6, padding='same')#32
        self.pool2 = tf.layers.max_pooling2d(self.conv2, 2, 2)  # 16*16*128

        self.conv3=tf.layers.conv2d(self.pool2,256,14,1,activation=tf.nn.relu6)
